...
Stdlib only. Walks an agent-friendly-docs / OKF tree, reads every markdown file
...
superseded_by. You never hand-edit the HTML — re-run this script (or let the
watcher / "Keep this current" step call it) and the graph tracks the docs.
